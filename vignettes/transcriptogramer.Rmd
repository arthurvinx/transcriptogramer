...
the radius slot. Only window related metrics will be affected by the radius change. Note that the sum of the window modularity increased using the radius 80.
...
However, the connectivityProperties() method does not uses a window, thus, its output is not
