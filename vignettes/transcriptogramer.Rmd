...
author:
- name: Diego Morais
  affiliation: Bioinformatics Multidisciplinary Environment, Natal, Brazil
...
from microarray or RNA-Seq assays^[logCPM values], and a dictionary. This example uses the
datasets **GSE9988**,
...
discovery rate will be set to 0.01. If the name of a species is provided
...
ten clusters were detected, and each one is represented by a color. It is
...
discovery rate will be set to 0.005. This method uses the biomaRt package to
